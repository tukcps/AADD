...
AAF mag(const AAF & re, const AAF & im)
{
  ...
  Temp.center+=((ampl_max-Temp.getMax())+(ampl_min-Temp.getMin()))/2.0;
    
  Temp.indexes[ltemp-1] = Temp.inclast();
  Temp.deviations[ltemp-1] = ((ampl_max-Temp.getMax())-(ampl_min-Temp.getMin()))/2.0;;
