...
SCA_TDF_MODULE(tank)
{
    ...
    void processing()
    {
        ...
        opt_sol bounds=wlevel.GetBothBounds();
    ...
    SCA_CTOR(tank)
    {
        uncertainty1=AADD(-0.1, 0.1);
        uncertainty2=AADD(-0.1, 0.1);
    }
};
...
SCA_TDF_MODULE(controller)
{
    ...
    void processing()
    {
        ifS( l5.read() == true )  pump=true; endS;
        ifS( g10.read() == true ) pump=false; endS; 
     }
...
SCA_TDF_MODULE(drain)
{
    ...
    void processing()
    {
        ...
        // cout << "NUMBER OF LEAFS: " << in.read().numLeafs() << endl;
