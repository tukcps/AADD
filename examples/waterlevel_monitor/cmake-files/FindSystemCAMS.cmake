...
find_path(SYSTEMCAMS_INCLUDE_DIR NAMES systemc-ams systemc-ams.h HINTS $ENV{SYSTEMCAMS_BASE} $ENV{SYSTEMCAMS}
          PATH_SUFFIXES src include
          DOC "The SystemC-AMS include directory"
)

find_library(SYSTEMCAMS_LIBRARY NAMES systemc-ams HINTS $ENV{SYSTEMCAMS_BASE} $ENV{SYSTEMCAMS} 
          PATH_SUFFIXES  lib lib-linux lib-linux64 lib-macosx lib-macosx64 lib-darwin
          DOC "The SystemC-AMS library"
)

# does not work with SystemC AMS 2.1 as there is no config.h. 
# unclear how to determine version ... 
#
